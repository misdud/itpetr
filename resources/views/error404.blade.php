...
<body>	
	<div class="jumbotron">
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2395 1800" width="400">
                <defs>
                    <style>
		...
		<div class="text-center">
            <h1 class="display-5 text-muted">Oops. Неизвестная ошибка.</h1>
			
			   <p class="h6">Не волнуйтесь, иногда даже мы ошибаемся.
                Вы можете найти множество других вещей на нашей главной странице.</p>
			
                <p class="lead pt-3">
                <a class="btn btn-primary btn-lg" href="{{ route('login') }}" role="button">Перейти на главную</a>
                </p>
        </div>
    </div>
