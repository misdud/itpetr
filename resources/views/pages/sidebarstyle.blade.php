<div class="fixed-plugin">
    <div class="dropdown show-dropdown">
        <a href="www.it.kali" data-toggle="dropdown">
            <i class="fa fa-cog fa-2x"> </i>
        Setup</a>
        <ul class="dropdown-menu">
            <li class="header-title"> {{ __('Стиль панели') }}</li>
            ...
            <li class="header-title">{{ __('Sidebar FOTO') }}</li>
            <li class="active">
            ...
            <li class="button-container">
                <div class="">
                    <a href="https://www.it.kali" target="_blank" class="btn btn-info btn-block btn-fill">{{ __("IT.KALI") }}</a>
                </div>
            </li>
