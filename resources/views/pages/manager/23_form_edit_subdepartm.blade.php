                    ...
                    <div class="card-body table-full-width table-responsive pl-4">
                        <form class="pl-3  pt-3" action="{{ route('sub_departments.update',  ['sub_department'=>$dataSubDepart->id ] ) }}" method='POST'>
                            ...
                            <div class="form-group pt-3">
                                ...
                                <input type="text" name="name" class="form-control" id="nameSubDepart" aria-describedby="nameHelp" value="{{ $dataSubDepart->name_subdepart }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="numPriori" value="{{ $dataSubDepart->priori_sub }}" class="form-control" id="priori_sdep" >
