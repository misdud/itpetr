                    ...
                    <div class="card-body table-full-width table-responsive pl-4">
                        <form class="pl-3  pt-3" action="{{ route('user_deprt') }}" method="GET">
                            ...
                            <div class="form-group pt-3 my-size">
                                ...
                                <input type="text" name="name" class="form-control" id="nameUsr"  placeholder="Введите фио">
                            ...
                            <button type="submit" class="btn btn-primary float-right ml-2"></i>Далее </button>
