                    ...
                    <div class="card-body table-full-width table-responsive pl-4">
                        <form class="pl-3  pt-3" action="{{ route('departments.update',  ['department'=>$dataDepart->id ] ) }}" method='POST'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="nameDepart" aria-describedby="nameHelp" value="{{ $dataDepart->name_depart }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="numPriori" value="{{ $dataDepart->priori }}" class="form-control" id="priori_dep" readonly="readonly">
                            </div>
